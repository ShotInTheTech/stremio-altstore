...
[![Update source](https://github.com/shotinthetech/stremio-altstore/actions/workflows/update.yml/badge.svg)](https://github.com/shotinthetech/stremio-altstore/actions/workflows/update.yml)
...
<p align="center">
  <a href="https://shotinthetech.github.io/stremio-altstore/install.html">
...
|---|---|---|
| iOS / iPadOS | [Open in AltStore](altstore://source?url=https://shotinthetech.github.io/stremio-altstore/stremio-ios.json) | [Open in SideStore](sidestore://source?url=https://shotinthetech.github.io/stremio-altstore/stremio-ios.json) |
| tvOS | [Open in AltStore](altstore://source?url=https://shotinthetech.github.io/stremio-altstore/stremio-tvos.json) | [Open in SideStore](sidestore://source?url=https://shotinthetech.github.io/stremio-altstore/stremio-tvos.json) |
...
| Platform | Source URL |
|---|---|
| iOS / iPadOS | `https://shotinthetech.github.io/stremio-altstore/stremio-ios.json` |
| tvOS | `https://shotinthetech.github.io/stremio-altstore/stremio-tvos.json` |
...
```
https://raw.githubusercontent.com/shotinthetech/stremio-altstore/main/stremio-ios.json
https://raw.githubusercontent.com/shotinthetech/stremio-altstore/main/stremio-tvos.json
```

Some signing apps require the `Content-Type: application/json` header, which GitHub Pages guarantees; raw URLs occasionally delay that header — prefer the `shotinthetech.github.io` URLs above.
...
```bash
# Clone the repo
git clone https://github.com/shotinthetech/stremio-altstore.git
cd stremio-altstore
